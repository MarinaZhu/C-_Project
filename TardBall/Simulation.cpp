...
Simulation::Simulation() :
	window(sf::VideoMode(480, 480), sf::String("Ball"))
{
	currentBox = nullptr;
	...
	textBoxes.push_back(new TextBox(0, 10, 80, 3, "VelocityX", &initialVelocity.x, "0"));
	textBoxes.push_back(new TextBox(100, 10, 80, 3, "VelocityY", &initialVelocity.y, "0"));
	textBoxes.push_back(new TextBox(200, 10, 85, 3, "Elasticity", &elasticity, "0.5"));
	textBoxes.push_back(new TextBox(305, 10, 80, 3, "Gravity", &gravity, "9.82"));
	textBoxes.push_back(new TextBox(405, 10, 80, 3, "Friction", &friction, "1.0"));
